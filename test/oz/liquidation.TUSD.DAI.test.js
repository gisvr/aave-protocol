...
describe("AAVE Liquidation repay DAI havest TUSD", function () {
    ...
    it("aave liquidation repay DAI harvest TUSD", async () => {
        ...
        // let maxPrincipalAmountToLiquidate = reserveData.principalBorrowBalance.mul(new BN(50)).div(oneHundredBN);
        ...
        // avaiableCollateral.principalAmountNeeded

        if(new BN(_purchaseAmount).gt(maxPrincipalAmountToLiquidate)){
            // 抵押物的 利息 userCompoundedBorrowBalance
            // let _purchaseAmountNeed =  collateralPrice.mul(_userCollateralBalance).div(reservePrice).mul(oneHundredBN).div(bonus);
            //expected '374062500000000000000' to equal '374062501884598131077'
            //expected '374062501739629043734' to equal '374062501884598131077'
